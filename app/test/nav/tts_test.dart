...
void main() {
  ...
  group('NativeTtsSpeaker', () {
    ...
    test('init true makes speak reach the native channel with the text', () async {
    ...
    test('init false makes every later speak a no-op — no channel call at all',
        () async {
      initResult = false;
      final speaker = NativeTtsSpeaker();
    ...
    test('shutdown reaches the channel once initialised, and is a no-op before',
        () async {
      final speaker = NativeTtsSpeaker();
