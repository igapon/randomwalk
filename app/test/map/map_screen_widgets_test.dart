...
void main() {
  ...
  group('PlanModeSegmentedButton — task 7: 4-segment narrow-phone overflow',
      () {
    ...
    Future<void> pumpAt(WidgetTester tester, double width, PlanMode mode) async {
      ...
      await tester.pumpWidget(MaterialApp(
        ...
        home: Scaffold(
          body: Padding(
            ...
            child: PlanModeSegmentedButton(selected: mode, onChanged: (_) {}),
          ),
        ),
      ));
    }
    ...
    testWidgets(
        ...
        'Explorer sits off-screen until scrolled to)', (tester) async {
      PlanMode? tapped;
      await tester.binding.setSurfaceSize(const Size(360, 800));
      addTearDown(() => tester.binding.setSurfaceSize(null));
      await tester.pumpWidget(MaterialApp(
    ...
    testWidgets('null onChanged disables the selector (recording guard)',
      ...
      await tester.pumpWidget(const MaterialApp(
        home: Scaffold(
          body: PlanModeSegmentedButton(selected: PlanMode.loop, onChanged: null),
        ),
      ));

      final button =
          tester.widget<SegmentedButton<PlanMode>>(find.byType(SegmentedButton<PlanMode>));
